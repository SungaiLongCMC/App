...
import 'package:services/utils/infinite_rotation.dart';
import 'package:flutter/material.dart';

import 'custom_indicator.dart';

class SimpleIndicatorContent extends StatelessWidget {
  const SimpleIndicatorContent({Key? key, 
    required this.controller,
    this.indicatorSize = _defaultIndicatorSize,
  }) : assert(indicatorSize > 0), super(key: key);
        ...
        child: Stack(
          children: <Widget>[
            AnimatedBuilder(
              ...
              builder: (context, child) => InfiniteRotation(
